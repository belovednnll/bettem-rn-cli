...
package com.bettem.bettemrn.webview;
...
import com.bettem.bettemrn.network.OkHttpClientProvider;
...
public class CustomReactWebViewManager extends SimpleViewManager<WebView> {

  protected static final String REACT_CLASS = "RCTHttpsWebView";
  ...
  protected static class ReactWebViewClient extends WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest (final WebView view, WebResourceRequest interceptedRequest) {
      return processRequest(interceptedRequest.getUrl().toString());
    }
    ...
    private WebResourceResponse processRequest(String url) {
      ...
      try{
        ...
        for (int i = 0;i < length; i++) {
          if("Content-Type".equals(headers.name(i))){
            contentType = headers.value(i);
          }
          if("Content-Encoding".equals(headers.name(i))){
            contentEncoding = headers.value(i);
          }
        }
    ...
    public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
        ...
        // handlerSsl(handler,view)
    }
      // 证书是自签名的
      private void handlerSsl(final SslErrorHandler handler, String url) {
  ...
  public CustomReactWebViewManager() {
  ...
  public CustomReactWebViewManager(WebViewConfig webViewConfig) {
