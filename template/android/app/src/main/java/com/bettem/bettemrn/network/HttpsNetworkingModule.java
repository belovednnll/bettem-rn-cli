 ...
 */
@ReactModule(name = HttpsNetworkingModule.NAME)
public final class HttpsNetworkingModule extends ReactContextBaseJavaModule {

  protected static final String NAME = "HttpsNetworkingModule";
   ...
   * @param context the ReactContext of the application
   */
  public HttpsNetworkingModule(final ReactApplicationContext context) {
   ...
   * caller does not provide one explicitly
   */
  public HttpsNetworkingModule(ReactApplicationContext context, String defaultUserAgent) {
