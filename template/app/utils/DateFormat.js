...
DateFormat.hoursAndMinutes = (hours, minutes) =>
  (Math.round((hours + minutes / 60) * 100) / 100).toString()
 ...
 */
DateFormat.shortDateFormat = (dateTime, locale) =>
  DateFormat.format(dateTime, locale ? locale.shortDateFormat : 'n/j/Y', locale)
